...
export class ResumeFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   this.infoFormatted = this._data1.aboutInfo;
    // }
  ...
  // onSubmit() {
  //   var data = { id:Math.random(), firstName: this.fname, lastName: this.lname, DOB: this.dateValue, imageUrl:this.urlValue,aboutInfo:this.infoFormatted}
  //   localStorage.setItem("formdata", JSON.stringify(data));
  //   // console.log(data);
  //   // console.log("get",localStorage.getItem('formdata'));
  ...
  submit() {
    if (
      ...
      // this.newSubmit();
      // (this._viewService.data3[0].id = Math.random()),
    ...
    //     first: this.fname,
    //     last: this.lname,
    //     birth: this.dateValue,
    //     url: this.urlValue,
    //     _info: this.infoFormatted,

    //   };
    //   this._viewService.data3.push();
    //   console.log(this._viewService.data3);
    //   this.onSubmit()
    // }
  ...
  newSubmit(
    ...
    if (
      ...
      this._basic.data5.push(storage);
      console.log(this._basic.data5)
      this.submit();
  ...
  getinfo(event: any) {
    const arr: string[] = [...this.info]; //String converted into array ==> means info data is copied to arr
    var bCount = this.info.split('*').length - 1;        //"..." spread operator
